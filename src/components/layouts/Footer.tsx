...
const footerSections: FooterSection[] = [
  {
    title: 'Visas',
    links: [
      { label: 'Work Visas', href: '/visas/category/work' },
      { label: 'Family Visas', href: '/visas/category/family' },
      { label: 'Student Visas', href: '/visas/category/student' },
      { label: 'Business Visas', href: '/visas/category/business' },
    ],
  },
  {
    title: 'Services',
    links: [
      { label: 'Visa Tracker', href: '/tracker' },
      { label: 'Find a Lawyer', href: '/lawyers' },
      { label: 'Consultations', href: '/user/consultations' },
      { label: 'Document Checklist', href: '/user/documents' },
    ],
  },
  {
    title: 'Resources',
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">VisaHelper</span>
            </Link>
            <p className="text-slate-400 text-sm mb-6">
              Simplifying Australian visa applications with expert guidance and powerful tools.
            </p>
            {/* Social Links */}
